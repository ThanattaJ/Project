 ...
 * @author user
 */
public class HistoryAdminGUI extends javax.swing.JFrame {
    private String whatToSearch;
    private History h = new History();
//    private String textAreaHistoryAdmin = h.statGreensociety();
    /**
     * Creates new form 
     */
    public HistoryAdminGUI() {
        initComponents();
        String borrow = h.showBorrowUser(111);
        String returnDate = h.showReturnUser(111);
        String repairDate = h.showRepairUser(222);
//        textAreaHistoryAdmin.setSize(300, 100);
        
        jTextAreaHistoryAdmin.setAlignmentX(CENTER_ALIGNMENT);
        jTextAreaHistoryAdmin.setAlignmentY(CENTER_ALIGNMENT);
        jTextAreaHistoryAdmin.setText(h.statGreensociety(setSize(WIDTH, HEIGHT)));
//        jTextAreaHistoryAdmin.insert(textAreaHistoryAdmin, 1);
    ...
    private void initComponents() {
        ...
        jTextAreaHistoryAdmin = new javax.swing.JTextArea();
        jPanelBehindHistoryAdmin = new javax.swing.JPanel();
        ...
        jTextAreaHistoryAdmin.setBackground(new java.awt.Color(51, 153, 255));
        jTextAreaHistoryAdmin.setColumns(20);
        jTextAreaHistoryAdmin.setFont(new java.awt.Font("Leelawadee", 0, 14)); // NOI18N
        jTextAreaHistoryAdmin.setForeground(new java.awt.Color(255, 255, 255));
        jTextAreaHistoryAdmin.setRows(5);
        jScrollPane1.setViewportView(jTextAreaHistoryAdmin);

        jPanelHistoryGuiUser.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 200, 490, 200));

        jPanelBehindHistoryAdmin.setBackground(new java.awt.Color(0, 51, 102));

        javax.swing.GroupLayout jPanelBehindHistoryAdminLayout = new javax.swing.GroupLayout(jPanelBehindHistoryAdmin);
        jPanelBehindHistoryAdmin.setLayout(jPanelBehindHistoryAdminLayout);
        jPanelBehindHistoryAdminLayout.setHorizontalGroup(
            jPanelBehindHistoryAdminLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 510, Short.MAX_VALUE)
        );
        jPanelBehindHistoryAdminLayout.setVerticalGroup(
            jPanelBehindHistoryAdminLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 220, Short.MAX_VALUE)
        );

        jPanelHistoryGuiUser.add(jPanelBehindHistoryAdmin, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 190, 510, 220));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HistoryAdminGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HistoryAdminGUI().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JPanel jPanelBehindHistoryAdmin;
    ...
    private javax.swing.JTextArea jTextAreaHistoryAdmin;
